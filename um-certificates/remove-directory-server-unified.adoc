...
summary: 若要中斷目錄伺服器與 Web Services Proxy 之間的連接，您可以從「存取管理」頁面中刪除伺服器資訊。如果您配置了新伺服器，然後想要刪除舊伺服器，則可能需要執行此操作。 
---
= 移除目錄伺服器
:allow-uri-read: 
:icons: font
...
[role="lead"]
若要中斷目錄伺服器與 Web Services Proxy 之間的連接，您可以從「存取管理」頁面中刪除伺服器資訊。如果您配置了新伺服器，然後想要刪除舊伺服器，則可能需要執行此操作。
